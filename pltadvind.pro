...
; Making the inner core white
  ...
  maxar=MAX([MAX(totadvr),MAX(totadvrs)])
  maxir=MAX([MAX(totindr),MAX(totindrs)])
  maxat=MAX([MAX(totadvt),MAX(totadvts)])
  maxit=MAX([MAX(totindt),MAX(totindts)])
  maxap=MAX([MAX(totadvp),MAX(totadvps)])
  maxip=MAX([MAX(totindp),MAX(totindps)])
  maxar1=MAX([MAX(abadvr1),MAX(abadvr1s)])
  maxir1=MAX([MAX(abindr1),MAX(abindr1s)])
  maxar2=MAX([MAX(abadvr2),MAX(abadvr2s)])
  maxir2=MAX([MAX(abindr2),MAX(abindr2s)])
  maxar3=MAX([MAX(abadvr3),MAX(abadvr3s)])
  maxir3=MAX([MAX(abindr3),MAX(abindr3s)])
  maxat1=MAX([MAX(abadvt1),MAX(abadvt1s)])
  maxit1=MAX([MAX(abindt1),MAX(abindt1s)])
  maxat2=MAX([MAX(abadvt2),MAX(abadvt2s)])
  maxit2=MAX([MAX(abindt2),MAX(abindt2s)])
  maxat3=MAX([MAX(abadvt3),MAX(abadvt3s)])
  maxit3=MAX([MAX(abindt3),MAX(abindt3s)])
  maxap1=MAX([MAX(abadvp1),MAX(abadvp1s)])
  maxip1=MAX([MAX(abindp1),MAX(abindp1s)])
  maxap2=MAX([MAX(abadvp2),MAX(abadvp2s)])
  maxip2=MAX([MAX(abindp2),MAX(abindp2s)])
  maxap3=MAX([MAX(abadvp3),MAX(abadvp3s)])
  maxip3=MAX([MAX(abindp3),MAX(abindp3s)])

  minar=MIN([MIN(totadvr),MIN(totadvrs)])
  minir=MIN([MIN(totindr),MIN(totindrs)])
  minat=MIN([MIN(totadvt),MIN(totadvts)])
  minit=MIN([MIN(totindt),MIN(totindts)])
  minap=MIN([MIN(totadvp),MIN(totadvps)])
  minip=MIN([MIN(totindp),MIN(totindps)])
  minar1=MIN([MIN(abadvr1),MIN(abadvr1s)])
  minir1=MIN([MIN(abindr1),MIN(abindr1s)])
  minar2=MIN([MIN(abadvr2),MIN(abadvr2s)])
  minir2=MIN([MIN(abindr2),MIN(abindr2s)])
  minar3=MIN([MIN(abadvr3),MIN(abadvr3s)])
  minir3=MIN([MIN(abindr3),MIN(abindr3s)])
  minat1=MIN([MIN(abadvt1),MIN(abadvt1s)])
  minit1=MIN([MIN(abindt1),MIN(abindt1s)])
  minat2=MIN([MIN(abadvt2),MIN(abadvt2s)])
  minit2=MIN([MIN(abindt2),MIN(abindt2s)])
  minat3=MIN([MIN(abadvt3),MIN(abadvt3s)])
  minit3=MIN([MIN(abindt3),MIN(abindt3s)])
  minap1=MIN([MIN(abadvp1),MIN(abadvp1s)])
  minip1=MIN([MIN(abindp1),MIN(abindp1s)])
  minap2=MIN([MIN(abadvp2),MIN(abadvp2s)])
  minip2=MIN([MIN(abindp2),MIN(abindp2s)])
  minap3=MIN([MIN(abadvp3),MIN(abadvp3s)])
  minip3=MIN([MIN(abindp3),MIN(abindp3s)])
