; $Id: polar_contour.pro,v 1.6.4.1 1999/01/16 16:43:28 scottm Exp $
;
; Copyright (c) 1995-1999, Research Systems, Inc.  All rights reserved.
;       Unauthorized reproduction prohibited.

PRO Polar_Contour2, z, theta, r, SHOW_TRIANGULATION=show, DITHER=dither, $
         _Extra = e
;
;+
; NAME:
...
contour, z, y, x, TRIANGULATION=tr, _EXTRA=e
